...
The intended tone is **Celestial Violet × Personal Constellation**: intimate, spiritual, quietly mysterious, and contemporary. Use layered violet night surfaces, sparse animated starlight, soft Chinese-first sans typography, fine lavender borders, and restrained rose, sky-blue, and warm-star accents. Keep the star field atmospheric and readable rather than neon or decorative noise. Avoid glowing-crystal clichés, copied zodiac artwork, dragons, excessive ornament, faux-ancient textures, and casino-like “luck scores.”
